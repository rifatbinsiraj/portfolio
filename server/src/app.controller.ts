  ...
  getProjects(): Project[] {
    return [
      ...
      },
      {
        ...
        url: 'https://callcenter.drutoai.com/',
        image: '/images/proj_ai-call-center.svg',
      ...
      },
      {
        ...
        url: 'https://learn.drutoai.com/',
        image: '/images/proj_eduai.svg',
        tech: 'React, TypeScript, Vite, Tailwind, NestJS, Fastify, MongoDB, Anthropic Claude',
        external: true,
      },
      {
        title: 'BD Payment Verify',
        url: 'https://pay.drutoai.com/',
        image: '/images/proj_payment-verify.svg',
      ...
      },
      {
        ...
        url: 'https://shop.drutoai.com/',
        image: '/images/proj_shopverse.svg',
        tech: 'NestJS, MongoDB, React, Vite, Tailwind, Redux Toolkit, AWS S3, JWT',
        external: true,
      },
      {
        title: 'files-to-markdown (npm)',
        url: 'https://www.npmjs.com/package/files-to-markdown',
        image: '/images/proj_files-to-markdown.svg',
        tech: 'Node-native npm package converting PDF, Word, Excel, CSV, HTML, JSON, text & images to Markdown to cut LLM token usage',
        external: true,
      },
    ];
  }
